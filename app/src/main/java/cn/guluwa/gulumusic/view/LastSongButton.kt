...
class LastSongButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    private fun initPaint() {
        ...
        mViewPath!!.moveTo((viewWidth + paddingLeft).toFloat(), (mViewHeight / 2 + paddingTop).toFloat())
        mViewPath!!.lineTo((mViewWidth - viewWidth + paddingLeft).toFloat(), (viewWidth + paddingTop).toFloat())
        mViewPath!!.lineTo((mViewWidth - viewWidth + paddingLeft).toFloat(), (mViewHeight - viewWidth + paddingTop).toFloat())
        mViewPath!!.lineTo((viewWidth + paddingLeft).toFloat(), (mViewHeight / 2 + paddingTop).toFloat())
    }

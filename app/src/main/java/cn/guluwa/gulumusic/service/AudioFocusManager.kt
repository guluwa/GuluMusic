...
class AudioFocusManager(private val mPlayService: MusicAutoService) : AudioManager.OnAudioFocusChangeListener {
    private val mAudioManager: AudioManager = mPlayService.getSystemService(AUDIO_SERVICE) as AudioManager
    ...
    private fun willPlay(): Boolean {
        return mPlayService.binder.mediaPlayer!!.isPlaying
    }
